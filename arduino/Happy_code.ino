...
void loop() {
  ...
  String hoogte = String((temperatuurOpHoogte - gemiddeldeTemperatuur) / -0.0065);

  gpsLat = fix.latitudeL();
  gpsLon = fix.longitudeL();
